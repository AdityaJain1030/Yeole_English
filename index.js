...
const startBrowser = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield e2s.goto('https://lingojam.com/EnglishtoShakespearean');
    return [b, e2s];
});
...
client.on('message', (msg) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (msg.content.startsWith(process.env.PREFIX) && msg.author.bot === false) {
        const last = (_a = msg.channel.lastMessage) === null || _a === void 0 ? void 0 : _a.author.bot;
        if (msg.content.slice(1, 10).toLowerCase() === "translate") {
            const text = msg.content.slice(10, msg.content.length);
            const x = yield translate(_page, text);
            msg.channel.send(x);
        }
        else if (!last) {
