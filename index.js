...
var cleverbot_free_1 = require("cleverbot-free");
...
var startBrowser = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, puppeteer_1["default"].launch({ args: [
                        '--no-sandbox',
            ...
            case 2:
                e2s = _a.sent();
                return [4 /*yield*/, e2s.goto('https://lingojam.com/EnglishtoShakespearean')];
            case 3:
                _a.sent();
...
client.on('message', function (msg) { return __awaiter(void 0, void 0, void 0, function () {
    var last, text, x, x, old;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (!(msg.content.startsWith(process.env.PREFIX) && msg.author.bot === false)) return [3 /*break*/, 5];
                last = (_a = msg.channel.lastMessage) === null || _a === void 0 ? void 0 : _a.author.bot;
                if (!(msg.content.slice(1, 10).toLowerCase() === "translate")) return [3 /*break*/, 2];
                text = msg.content.slice(10, msg.content.length);
                return [4 /*yield*/, translate(_page, text)];
            case 1:
                x = _b.sent();
                msg.channel.send(x);
                return [3 /*break*/, 5];
            case 2:
                ...
                return [4 /*yield*/, cleverbot_free_1["default"](msg.content.slice(1, msg.content.length))];
            case 3:
                x = _b.sent();
...
client.on('guildMemberAdd', function (member) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        if (!((_a = member.user) === null || _a === void 0 ? void 0 : _a.bot)) {
            role = member.guild.roles.cache.find(function (role) { return role.name === 'person'; });
            try {
                member.roles.add(role || '');
            }
            catch (err) {
                (_b = member.user) === null || _b === void 0 ? void 0 : _b.send('Could Not Give Role. DM @DebigPotato6414 for more information');
            }
        }
        return [2 /*return*/];
    });
